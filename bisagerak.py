...
def rambut():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_POLYGON)
    glVertex2f(23 + pos_x, 244 + pos_y)
    glVertex2f(19 + pos_x, 247 + pos_y)
    glVertex2f(22 + pos_x, 256 + pos_y)
    glVertex2f(31 + pos_x, 254 + pos_y)
    glVertex2f(31 + pos_x, 254 + pos_y)
    glEnd()
...
def wajah():
    ...
    glBegin(GL_POLYGON)
    glVertex2f(30 + pos_x, 241 + pos_y)
    glVertex2f(23 + pos_x, 244 + pos_y)
    glVertex2f(23 + pos_x, 253 + pos_y)
    glVertex2f(31 + pos_x, 254 + pos_y)
    glVertex2f(40 + pos_x, 252 + pos_y)
    glVertex2f(40 + pos_x, 244 + pos_y)
    glVertex2f(33 + pos_x, 241 + pos_y)    
    glEnd()
...
def bibir():
    ...
    glColor3ub(26, 26, 26)
    glBegin(GL_POLYGON)
    glVertex2f(30 + pos_x, 242 + pos_y)
    glVertex2f(29 + pos_x, 243 + pos_y)
    glVertex2f(29 + pos_x, 244 + pos_y)
    glVertex2f(34 + pos_x, 244 + pos_y)
    glVertex2f(34 + pos_x, 243 + pos_y)
    glVertex2f(33 + pos_x, 242 + pos_y)
    glEnd()
...
def lidah():
    ...
    glBegin(GL_POLYGON)
    glVertex2f(30 + pos_x, 242 + pos_y)
    glVertex2f(31 + pos_x, 243 + pos_y)
    glVertex2f(32 + pos_x, 243 + pos_y)
    glVertex2f(33 + pos_x, 242 + pos_y)
    glEnd()
...
def hidung():
    ...
    glBegin(GL_TRIANGLES)
    glVertex2f(31 + pos_x, 245 + pos_y)
    glVertex2f(32 + pos_x, 246 + pos_y)
    glVertex2f(33 + pos_x, 245 + pos_y)
    glEnd()
...
def bingkaiKiri():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_POLYGON)
    glVertex2f(26 + pos_x, 248 + pos_y)
    glVertex2f(23 + pos_x, 250 + pos_y)
    glVertex2f(23 + pos_x, 251 + pos_y)
    glVertex2f(26 + pos_x, 249 + pos_y)
    glEnd()
...
def kacaKiri():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_QUADS)
    glVertex2f(26 + pos_x, 247 + pos_y)
    glVertex2f(26 + pos_x, 250 + pos_y)
    glVertex2f(30 + pos_x, 250 + pos_y)
    glVertex2f(30 + pos_x, 247 + pos_y)
    glEnd()
...
def mataKiri():
    ...
    glColor3ub(255, 228, 196)
    glBegin(GL_QUADS)
    glVertex2f(27 + pos_x, 248 + pos_y)
    glVertex2f(27 + pos_x, 249 + pos_y)
    glVertex2f(29 + pos_x, 249 + pos_y)
    glVertex2f(29 + pos_x, 248 + pos_y)
    glEnd()
...
def bingkaiTengah():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_QUADS)
    glVertex2f(30 + pos_x, 248 + pos_y)
    glVertex2f(30 + pos_x, 249 + pos_y)
    glVertex2f(33 + pos_x, 248 + pos_y)
    glVertex2f(33 + pos_x, 249 + pos_y)
    glEnd()
...
def kacaKanan():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_QUADS)
    glVertex2f(33 + pos_x, 247 + pos_y)
    glVertex2f(33 + pos_x, 250 + pos_y)
    glVertex2f(37 + pos_x, 250 + pos_y)
    glVertex2f(37 + pos_x, 247 + pos_y)
    glEnd()
...
def bingkaiKanan():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_POLYGON)
    glVertex2f(37 + pos_x, 248 + pos_y)
    glVertex2f(37 + pos_x, 249 + pos_y)
    glVertex2f(40 + pos_x, 251 + pos_y)
    glVertex2f(40 + pos_x, 250 + pos_y)
    glEnd()
...
def mataKanan():
    ...
    glColor3ub(255, 228, 196)
    glBegin(GL_QUADS)
    glVertex2f(34 + pos_x, 248 + pos_y)
    glVertex2f(34 + pos_x, 249 + pos_y)
    glVertex2f(36 + pos_x, 249 + pos_y)
    glVertex2f(36 + pos_x, 248 + pos_y)
    glEnd()
...
def leher():
    ...
    glColor3ub(255, 228, 196)
    glBegin(GL_POLYGON)
    glVertex2f(32 + pos_x, 238 + pos_y)
    glVertex2f(29 + pos_x, 240 + pos_y)
    glVertex2f(30 + pos_x, 241 + pos_y)
    glVertex2f(33 + pos_x, 241 + pos_y)
    glVertex2f(34 + pos_x, 240 + pos_y)
    glEnd()
...
def badan():
    ...
    glBegin(GL_POLYGON)
    #tangan kanan
    glVertex2f(45 + pos_x, 243 + pos_y)
    glVertex2f(44 + pos_x, 245 + pos_y)
    glVertex2f(39 + pos_x, 239 + pos_y)
    glVertex2f(40 + pos_x, 235 + pos_y)
    glVertex2f(38 + pos_x, 236 + pos_y)
    #badan
    glVertex2f(38 + pos_x, 226 + pos_y)
    glVertex2f(27 + pos_x, 226 + pos_y)
    glVertex2f(26 + pos_x, 237 + pos_y)
    #tangan kiri
    glVertex2f(25 + pos_x, 236 + pos_y)
    glVertex2f(23 + pos_x, 230 + pos_y)
    glVertex2f(26 + pos_x, 226 + pos_y)
    glVertex2f(26 + pos_x, 224 + pos_y)
    glVertex2f(19 + pos_x, 230 + pos_y)
    glVertex2f(23 + pos_x, 239 + pos_y)
    glVertex2f(29 + pos_x, 240 + pos_y)
    glVertex2f(32 + pos_x, 238 + pos_y)
    glVertex2f(34 + pos_x, 240 + pos_y)
    glEnd()
...
def logoLuar():
    ...
    glColor3ub(255, 255, 0)
    glBegin(GL_POLYGON)
    glVertex2f(32 + pos_x, 228 + pos_y)
    glVertex2f(29 + pos_x, 230 + pos_y)
    glVertex2f(27 + pos_x, 234 + pos_y)
    glVertex2f(29 + pos_x, 237 + pos_y)
    glVertex2f(35 + pos_x, 237 + pos_y)
    glVertex2f(37 + pos_x, 234 + pos_y)
    glVertex2f(35 + pos_x, 230 + pos_y)
    glEnd()
...
def logoH():
    ...
    glColor3ub(255, 0, 0)
    glBegin(GL_POLYGON)
    glVertex2f(30 + pos_x, 231 + pos_y)
    glVertex2f(30 + pos_x, 236 + pos_y)
    glVertex2f(31 + pos_x, 235 + pos_y)
    glVertex2f(31 + pos_x, 234 + pos_y)
    glVertex2f(33 + pos_x, 234 + pos_y)
    glVertex2f(33 + pos_x, 235 + pos_y)
    glVertex2f(34 + pos_x, 236 + pos_y)
    glVertex2f(34 + pos_x, 231 + pos_y)
    glVertex2f(33 + pos_x, 232 + pos_y)
    glVertex2f(33 + pos_x, 233 + pos_y)
    glVertex2f(31 + pos_x, 233 + pos_y)
    glVertex2f(31 + pos_x, 232 + pos_y)
    glEnd()
...
def segitigaBawah():
    ...
    glBegin(GL_TRIANGLES)
    glVertex2f(32 + pos_x, 228 + pos_y)
    glVertex2f(31 + pos_x, 230 + pos_y)
    glVertex2f(33 + pos_x, 230 + pos_y)
    glEnd()
...
def segitigaKiri():
    ...
    glColor3ub(255, 0, 0)
    glBegin(GL_TRIANGLES)
    glVertex2f(29 + pos_x, 233 + pos_y)
    glVertex2f(28 + pos_x, 234 + pos_y)
    glVertex2f(29 + pos_x, 235 + pos_y)
    glEnd() 
...
def segitigaKanan():
    ...
    glColor3ub(255, 0, 0)
    glBegin(GL_TRIANGLES)
    glVertex2f(35 + pos_x, 233 + pos_y)
    glVertex2f(36 + pos_x, 234 + pos_y)
    glVertex2f(35 + pos_x, 235 + pos_y)
    glEnd() 
...
def sabuk():
    ...
    glColor3ub(0,0,0)
    glBegin(GL_QUADS)
    glVertex2f(27 + pos_x, 223 + pos_y)
    glVertex2f(27 + pos_x, 226 + pos_y)
    glVertex2f(38 + pos_x, 226 + pos_y)
    glVertex2f(38 + pos_x, 223 + pos_y)
    glEnd()
...
def kaki():
    ...
    #kaki kanan
    glVertex2f(38 + pos_x, 223 + pos_y)
    glVertex2f(40 + pos_x, 216 + pos_y)
    glVertex2f(36 + pos_x, 207 + pos_y)
    glVertex2f(32 + pos_x, 209 + pos_y)
    glVertex2f(35 + pos_x, 215 + pos_y)
    glVertex2f(33 + pos_x, 219 + pos_y)
    #kaki kiri
    glVertex2f(32 + pos_x, 215 + pos_y)
    glVertex2f(29 + pos_x, 209 + pos_y)
    glVertex2f(24 + pos_x, 210 + pos_y)
    glVertex2f(28 + pos_x, 217 + pos_y)
    glVertex2f(27 + pos_x, 223 + pos_y)
    glEnd()
...
def sepatuKiri():
    glColor3ub(0, 0, 0)
    glBegin(GL_POLYGON)
    glVertex2f(30 + pos_x, 207 + pos_y)
    glVertex2f(23 + pos_x, 208 + pos_y)
    glVertex2f(24 + pos_x, 210 + pos_y)
    glVertex2f(29 + pos_x, 209 + pos_y)
    glVertex2f(29 + pos_x, 208 + pos_y)
    glEnd()
...
def sepatuKanan():
    ...
    glColor3ub(0, 0, 0)
    glBegin(GL_POLYGON)
    glVertex2f(35 + pos_x, 205 + pos_y)
    glVertex2f(30 + pos_x, 208 + pos_y)
    glVertex2f(32 + pos_x, 209 + pos_y)
    glVertex2f(36 + pos_x, 207 + pos_y)
    glVertex2f(35 + pos_x, 206 + pos_y)
    glEnd()
...
def sayap():
    ...
    glBegin(GL_POLYGON)
    glVertex2f(27 + pos_x, 223 + pos_y)
    glVertex2f(25 + pos_x, 220 + pos_y)
    glVertex2f(13 + pos_x, 222 + pos_y)
    glVertex2f(17 + pos_x, 237 + pos_y)
    glVertex2f(21 + pos_x, 242 + pos_y)
    glVertex2f(23 + pos_x, 241 + pos_y)
    glVertex2f(25 + pos_x, 242 + pos_y)
    glVertex2f(29 + pos_x, 240 + pos_y)
    glEnd()

def kotakhalangan():
    glPushMatrix()
    glTranslated(x_time, 0, 0) #kalo mau mindah objek
    glColor3ub(255,255,255)
    glBegin(GL_QUADS)
    glVertex(700, 240)
    glVertex(800, 240)
